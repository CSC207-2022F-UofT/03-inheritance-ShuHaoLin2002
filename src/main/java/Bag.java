...
public abstract class Bag {
     ...
     *
     * @return return last item in the Bag, if no items, return null
     */

    public String popItem() {
        int last = numberOfContents - 1;
        if (last >= 0) {
            String pop = this.contents[last];
            this.contents[last] = null;
            this.numberOfContents -= 1;
            return pop;
        }
        return null;
     ...
     *
     * @return return the details of this bag
     */
    @Override
